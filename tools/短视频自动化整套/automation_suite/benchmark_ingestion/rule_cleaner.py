...
def clean_transcript_rules(text: str) -> str:
    """Apply rule-based cleaning to ASR transcript.

    - Fixes common ASR homophone errors (看挂→看卦 etc.)
    - Removes filler words and phrases
    - Adds punctuation
    - Creates paragraphs at natural break points
    - Filters out obvious sales content
    """
